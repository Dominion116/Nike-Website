...
const App = () => {
  return (
    <main className="relative">
      ...
      <section className="sm:px-16 px-8 py-10">Service</section>
      <section className="sm:px-16 px-8 sm:py-24 py-12">SpecialOffers</section>
      <section className="sm:px-16 px-8 sm:py-24 py-12 bg-blue-50">
        CustomerReviews
      </section>
      <section className="sm:px-16 px-8 sm:py-32 py-16">Subscribe</section>
